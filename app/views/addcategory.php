...
a{color:#77d25b;} 
.headeroption {background: #77d25b url("img/php.png") no-repeat scroll 25px 12px;height: 74px;overflow: hidden;padding-left: 140px;}
.headeroption h2{color: #000;font-size: 30px;padding-top: 2px;text-shadow: 0 1px 1px #fff;}
.content{background: #fff;border: 6px solid #77d25b;font-size: 16px;line-height: 22px;margin-bottom: 3px;margin-top: 3px;min-height: 380px;overflow: hidden;padding: 10px;}
...
<body>
  <header class="headeroption">
    <h2> Complete PHP OOP MVC Framework Project </h2>
...
<form action="http://localhost:8080/mvc/CategoryController/insertCategory" method="post">
    <table>
        <tr>
             <td>Category Name</td>
