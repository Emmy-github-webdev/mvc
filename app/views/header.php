...
.postcontent{width:770px; border-right:1px solid #ddd; float: left; margin-right: 20px; paddind-right:20px; overflow:hidden;}
.post{
  margin-bottom: 40px;
  }
.post h2{
...
.widget h2{
  border: 1px solid #ddd; margin: 0 0 10px;
  padding: 4px 10px;
  overflow: hidden;
}
.widget ul{
...
.search{float: right;}
.catsearch{border: 1px solid #ddd; font-size: 16px; margin-bottom: 5px; padding: 5px; width: 230px; cursor: pointer;}
